...
//services
import { DistribucionConfirmarService } from './distribucion-confirmar.service';
...
@Component({
  selector: 'app-distribucion-confirmar',
  templateUrl: './distribucion-confirmar.component.html',
  styleUrls: ['./distribucion-confirmar.component.scss']
})

export class DistribucionConfirmarComponent implements OnInit {
  ...
  constructor(private _router: Router,
              private _service: DistribucionConfirmarService,
