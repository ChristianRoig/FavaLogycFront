...
@Component({  
  selector: 'app-comprobantes-a-programar',  
  templateUrl: './comprobantes-a-programar.component.html',
  styleUrls: ['./comprobantes-a-programar.component.scss']
})

export class ComprobantesAprogramarComponent implements OnInit {
  ...
  constructor(  private _router: Router, 
                ...
                private _comprobantesAprogramarService: ComprobantesAprogramarService,
  ...
  getComprobantesSinRemitir( ){
    this._comprobantesAprogramarService.getComprobantesSinRemitir( this.page, this.size, this.columna, this.order).subscribe(
      data => {
  ...
  getComprobanteSinRemitir(){
    this._comprobantesAprogramarService.getComprobanteSinRemitir( this.busqueda, this.page, this.size, this.columna, this.order ).subscribe(
      data => {
        this.dataSource2 = data.datos;
        this.length = data.totalRegistros;
        console.log(data);
  ...
  getPedidoDeArticuloSinRemitir( comprobante: string ){
    this._comprobantesAprogramarService.getPedidoDeArticuloSinRemitir( comprobante ).subscribe(
      data => {
        this.dataSource2 = data.datos;
        this.length = data.totalRegistros;
